...
//                                                          /                                                       /\        //  
//                                                         |                    .-'`'-.                            |  \       //  
//  Group: Six-One(-2)                                    /           ,-'`'.   '._     \     ______               /   /       //  
//  Authors:                                             |           /    .'  ___ `-._  |    \ .-'`              |   |\\      //  
//      Cody Vernon                                     /           |   .' ,-' __ `'/.`.'  ___\\                /   /         //  
//      Jack Harvison                                  |    ______  \ .' \',-' 12 '-.  '.  `-._ \              |   |          //  
//      Drake Farmer                                  /     '`-. /   ` / / 11    / 1 `.  `.    '.\            /   /           //  
//                                                   |         //___  . '10     /    2 \  ;                  |   |            //              
//  Assignment: Simulated CPU Scheduler             /         / _.-'  | |      O      3|  |  ______         /   /             //  
//  Course: CS 460 Operating Systems               |         /.'      | |9      \      '  '  '`-. /        |   |              //  
//                                                /            ______ '  \ 8     `   4/  /      //___     /   /               //  
//  Available Schedulers:                        |             \ .-'`  '. `'.7  6  5.'  '      / _.-'    |   |                //  
//      FCFS (First Come First Serve)           /            ___\\       `. _ `'''` _.'\\-.   /.'       /   /                 //  
//      SJF  (Shortest Job First)              |             `-._ \       .//`''--''   (   )           |   |                  //  
